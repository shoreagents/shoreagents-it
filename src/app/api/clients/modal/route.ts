...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🔍 Clients modal API called with:', { page, limit, search, companyId, sortField, sortDirection })

    const result = await getClientsForModal(page, limit, search, companyId, sortField, sortDirection)
